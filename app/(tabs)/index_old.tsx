...
export default function DashboardScreen() {
  ...
  const loadDashboardData = async (showRefreshing = false) => {
    ...
    try {
      ...
      const { data: profileData, error: profileError } = profileResponse as any;
      ...
      if (!profileData || profileData.length === 0) {
        ...
        const { data: newProfile, error: createError } = insertResponse as any;
      ...
      try {
        ...
        const currentProfile = profileData && profileData.length > 0 ? profileData[0] : null;
        const goalProgress = currentProfile?.daily_goal > 0 
          ? Math.min((income / currentProfile.daily_goal) * 100, 100)
          : 0;
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {sidebarOpen && (
        <Animated.View 
          entering={FadeIn?.duration?.(300) || undefined}
          exiting={FadeOut?.duration?.(200) || undefined}
          style={styles.modernOverlay}
        >
          <TouchableOpacity 
          ...
          <Animated.View 
            entering={SlideInLeft?.duration?.(400)?.springify?.() || undefined}
            exiting={SlideOutLeft?.duration?.(300) || undefined}
            style={styles.modernSidebar}
          >
            <BlurView intensity={20} style={styles.sidebarBlur}>
              ...
              >
                {/* Enhanced Header */}
                <Animated.View 
                  entering={FadeInDown?.delay?.(200)?.duration?.(500) || undefined}
                  style={styles.modernSidebarHeader}
                >
                  <TouchableOpacity 
                  ...
                  {profile && (
                    <View style={styles.modernSidebarProfile}>
                      <Animated.View 
                        entering={ZoomIn?.delay?.(300)?.duration?.(600)?.springify?.() || undefined}
                      ...
                      <Animated.Text 
                        entering={FadeInUp?.delay?.(400)?.duration?.(500) || undefined}
                        style={styles.modernSidebarName}
                      >
                        {profile.full_name}
                      </Animated.Text>
                      
                      <Animated.View 
                        entering={FadeInUp?.delay?.(500)?.duration?.(500) || undefined}
                ...
                {/* Enhanced Navigation */}
                <Animated.View 
                  entering={FadeInUp?.delay?.(300)?.duration?.(600) || undefined}
                  style={styles.modernSidebarNav}
                >
                  {[
                    ...
                    return (
                      <Animated.View
                        key={item.key}
                        entering={SlideInRight?.delay?.(400 + index * 100)?.duration?.(500)?.springify?.() || undefined}
                      >
                        <TouchableOpacity 
                ...
                {/* Enhanced Sign Out */}
                <Animated.View 
                  entering={FadeInUp?.delay?.(800)?.duration?.(500) || undefined}
      ...
      >
        ...
        <Animated.View entering={FadeInDown?.duration?.(800)?.springify?.() || undefined}>
          <LinearGradient
      ...
      <Animated.View 
        entering={FadeInUp?.delay?.(200)?.duration?.(600)?.springify?.() || undefined}
      ...
      {profile && (
        <Animated.View 
          entering={FadeInLeft?.delay?.(400)?.duration?.(800)?.springify?.() || undefined}
        ...
        >
          <BlurView intensity={15} style={styles.overviewBlur}>
            ...
            <View style={styles.modernStatsGrid}>
              <Animated.View entering={SlideInUp?.delay?.(100)?.springify?.() || undefined} style={styles.modernStatCard}>
              ...
              <Animated.View entering={SlideInUp?.delay?.(200)?.springify?.() || undefined} style={styles.modernStatCard}>
              ...
              <Animated.View entering={SlideInUp?.delay?.(300)?.springify?.() || undefined} style={styles.modernStatCard}>
              ...
              <Animated.View entering={SlideInUp?.delay?.(400)?.springify?.() || undefined} style={styles.modernStatCard}>
      ...
      <Animated.View 
        entering={FadeInRight?.delay?.(500)?.duration?.(800)?.springify?.() || undefined}
            ...
            <View style={styles.modernActivityList}>
              {recentActivity.slice(0, 4).map((activity, index) => (
                <Animated.View 
                  ...
                  entering={SlideInRight?.delay?.(600 + index * 150)?.duration?.(500)?.springify?.() || undefined}
      ...
      <Animated.View 
        entering={FadeInUp?.delay?.(600)?.duration?.(600)?.springify?.() || undefined}
      ...
      >
        ...
        <View style={styles.actionsGrid}>
          {getCategorySpecificActions(profile?.business_type || 'other_hustle').map((action, index) => {
            ...
            return (
              <Animated.View 
                key={index}
                entering={SlideInUp?.delay?.(800 + index * 150)?.duration?.(600)?.springify?.() || undefined}
              >
                <TouchableOpacity 
        ...
        <Animated.View entering={ZoomIn?.delay?.(1400)?.duration?.(800)?.springify?.() || undefined}>
          <TouchableOpacity 
      ...
      {recentActivity.length > 3 && (
        <Animated.View 
          entering={FadeInUp?.delay?.(1600)?.duration?.(600)?.springify?.() || undefined}
        ...
        >
          ...
          <View style={styles.activityList}>
            {recentActivity.slice(3).map((activity, index) => (
              <Animated.View 
                key={`${activity.id}-${activity.type}`}
                entering={SlideInRight?.delay?.(1700 + index * 100)?.duration?.(400) || undefined}
